...
| Display / reconciliation ordering | `(occurred_at, source_pk)` tie-break within an entity context only — not commit order, gap-free delivery, or canonical Audit sequence |
