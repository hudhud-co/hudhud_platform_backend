...
class EnvelopeInvalidError(NatsPublishError):
    def __init__(self, message: str = "envelope failed contract validation") -> None:
        super().__init__("ENVELOPE_INVALID", message)
