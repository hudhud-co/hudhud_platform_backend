...
from tracking.infrastructure.jetstream.deferred_transport import (
...
logger = logging.getLogger("tracking.pull_worker")


class TimelinePullWorker:
    ...
    async def _handle_message(self, msg: Any) -> None:
        ...
        try:
            ...
            logger.error(
                "tracking_handler_unhandled_error",
                extra={"error_code": type(exc).__name__},
            )
