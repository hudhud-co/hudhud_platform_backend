"""Durable inbox deduplication for events Notification consumes (ADR-0008)."""
...
from notification_fixtures import build_store, inbox_service
...
CONSUMER = "notification_pickup_accepted_v1"
OTHER_CONSUMER = "notification_hub_drop_off_v1"
