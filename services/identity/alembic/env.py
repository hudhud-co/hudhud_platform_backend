...
# stack, the disposable PostgreSQL proofs — supply IDENTITY_DATABASE_URL, so a migration
# can never be pointed at whatever happens to be in the checked-in config file.
_database_url = os.environ.get("IDENTITY_DATABASE_URL") or os.environ.get("DATABASE_URL")
if _database_url:
