...
class AckAfterCommitTransport:
    ...
    def __init__(self, client: JetStreamBrokerAckClient) -> None:
        self._client = client
...
def build_jetstream_transport(
    ...
    *,
    client: JetStreamBrokerAckClient | None = None,
