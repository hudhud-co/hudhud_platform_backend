"""Workforce's own durable inbox record (ADR-0008).
...
There is no outbox here. Workforce answers "is this driver assignable?" over HTTP and
publishes no integration events.
"""
